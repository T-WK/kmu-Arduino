...
// adjust servo position according to the USS read value
  ...
  else if (dist_raw > 180 && dist_raw < 360) myservo.writeMicroseconds((int)((_DUTY_MAX -_DUTY_MIN)/(dist_max-dist_min) * (dist_ema-dist_min))+_DUTY_MIN);
  else if (dist_raw >= 360) myservo.writeMicroseconds(_DUTY_MAX);
